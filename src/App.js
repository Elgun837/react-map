...
const App = () => {
  ...
  const [markers, setMarkers] = useState([
    ...
    },
    {
      ...
      images: [
        "./images/projects/Ganclikmall/genclikmall(1).webp",
        "./images/projects/Ganclikmall/genclikmall(2).webp",
        "./images/projects/Ganclikmall/genclikmall(3).webp",
        "./images/projects/Ganclikmall/genclikmall(4).webp",
        "./images/projects/Ganclikmall/genclikmall(5).webp",
        "./images/projects/Ganclikmall/genclikmall(6).webp",
      ],
      year: "2015-2016",
      class: "aze",
    },
